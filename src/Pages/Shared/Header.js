            ...
            <li>
                {
                    user ?
                        ...
                        <div class="dropdown dropdown-hover">
                            ...
                            <ul tabIndex="0" class="dropdown-content menu  mt-48 shadow bg-secondary rounded-box w-52">
    ...
    return (
        <div class="navbar h-20 bg-secondary">
            <div class="navbar-start mx-24">
                ...
                <label for="my-drawer-2" class="btn btn-secondary drawer-button lg:hidden">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                </label>
